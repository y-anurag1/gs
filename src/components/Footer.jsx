...
export const Footer = () => {
  ...
  const FooterLink = ({ href, children, onClick }) => (
    <a
      href={href}
      onClick={onClick}
      className="relative text-sm text-gray-600 hover:text-blue-600 transition-colors duration-200 group flex items-center justify-center sm:justify-start" // Changed text-xs to text-sm
    >
      {children}
      <span
  ...
  return (
    <footer className="bg-white py-12 md:py-16 text-gray-700">
      <div className="container mx-auto px-4 lg:px-8">
        {/* Main Footer Content Grid - Adjusted for 2 columns on mobile, 4 on desktop */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1fr_1.2fr_0.8fr_0.8fr] gap-4 md:gap-8 mb-10">
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            ...
            <p className="text-base text-gray-600 mt-2 max-w-[200px] mx-auto sm:mx-0">Your journey, our expertise.</p> {/* Changed text-sm to text-base */}
            <div className="flex space-x-4 mt-4">
              ...
              <a href="https://www.instagram.com/geoholidays_?igsh=MTE1MXluNzV3aHF6Zw==" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-600 transition-colors duration-200">
                <Instagram className="w-7 h-7" /> {/* Increased icon size to w-7 h-7 */}
              </a>
              ...
              <a href="https://www.facebook.com/share/1AB33Ktwmi/" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-blue-600 transition-colors duration-200">
                <Facebook className="w-7 h-7" /> {/* Increased icon size to w-7 h-7 */}
              </a>
              ...
              <a href="https://wa.me/917880170012" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-green-500 transition-colors duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" viewBox="0 0 16 16"> {/* Increased SVG size to 28x28 */}
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            <h3 className="font-semibold text-gray-900 mb-3 text-lg relative inline-block group">Contact Us {/* Changed text-base to text-lg */}
            ...
            <div className="space-y-2">
              <p className="flex items-center text-sm text-gray-600"> {/* Changed text-xs to text-sm */}
                <Phone className="w-4 h-4 text-blue-600 mr-2 flex-shrink-0" /> +91 78801 70012 {/* Changed icon size */}
              </p>
              <p className="flex items-center text-sm text-gray-600"> {/* Changed text-xs to text-sm */}
                <Mail className="w-4 h-4 text-blue-600 mr-2 flex-shrink-0" /> info@geoholidays.in {/* Changed icon size */}
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            <h3 className="font-semibold text-gray-900 mb-3 text-lg relative inline-block group">Quick Links {/* Changed text-base to text-lg */}
              <span className="absolute bottom-0 left-0 w-full h-[2px] bg-orange-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
            </h3>
          ...
          <div className="flex flex-col items-center sm:items-start text-center sm:text-left">
            <h3 className="font-semibold text-gray-900 mb-3 text-lg relative inline-block group">Other Links {/* Changed text-base to text-lg */}
              <span className="absolute bottom-0 left-0 w-full h-[2px] bg-orange-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left"></span>
            </h3>
            <ul className="space-y-2">
        ...
        <div className="border-t border-gray-200 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center text-base text-gray-600"> {/* Changed text-sm to text-base */}
